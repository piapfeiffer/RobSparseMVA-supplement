...
High_HO_break <- foreach(
  ...
  res_cont1 <- simulation_function(r, "HIGH_HO", "CONTAMINATED", methods, 0.1, kwargs)
  res_cont2 <- simulation_function(r, "HIGH_HO", "CONTAMINATED", methods, 0.2, kwargs)
  res_cont3 <- simulation_function(r, "HIGH_HO", "CONTAMINATED", methods, 0.3, kwargs)
  res_cont4 <- simulation_function(r, "HIGH_HO", "CONTAMINATED", methods, 0.4, kwargs)
  res_cont5 <- simulation_function(r, "HIGH_HO", "CONTAMINATED", methods, 0.5, kwargs)
...
save(High_HO_break, file = file.path("results","high_ho_break.Rdata"))
