...
High_HO_SRAR <- foreach(
  ...
  res_cont <- simulation_function(r, "HIGH_HO", "CONTAMINATED", 0.05)
  res_tdist <- simulation_function(r, "HIGH_HO", "T_DIST", 0)
...
save(High_HO_SRAR, file = file.path("results", "high_ho_SRAR.Rdata"))
